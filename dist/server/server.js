...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import("./assets/_tanstack-start-manifest_v-CUyzOnVw.js");
    case VIRTUAL_MODULES.serverFnManifest:
      return await import("./assets/_tanstack-start-server-fn-manifest_v-DAMp0GO0.js");
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-CwFYiwjT.js");
    }
    if (startEntry === null) {
      startEntry = await import("./assets/start-DqmiaVer.js");
    }
    return {
      startEntry,
      routerEntry
